...
Public Class InputDetails
    Private Sub bsubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bsubmit.Click
        ...
        If val Then
            ...
            excelfn()
            'wordfn()
            MessageBox.Show("Details Entered Into Database")
        Else
    ...
    Sub excelfn()
        ...
        Dim x As Integer
        MessageBox.Show("j=" & j)
        'Dim mns As String = "H" & j
        If (j < 3) Then
            j = 3
        End If
        x = oSheet.Range("H" & j - 1).value
        x = x + 1
        MessageBox.Show("x=" & x)
        ...
        oBook.SaveAs("D:\ExpImp\Export Data.xlsx")
        oBook.SaveAs("D:\ExpImp\Data Backup.xlsx")
    ...
    Private Sub wordfn(ByVal r As Integer)
        ...
        Dim PIctureLocation As String = "D:\ExpImp\india.jpg"
        ...
        docname = "D:\ExpImp\Certificates\Certificate RC no. " & r & ".docx"
        oDoc.SaveAs(docname)
